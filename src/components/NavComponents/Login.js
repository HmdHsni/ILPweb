...
<div class="w-full min-h-screen bg-gray-50 flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
  <div class="w-full sm:max-w-md p-5 mx-auto">
    <h2 class="mb-12 text-center text-2xl font-extrabold">ورود به پنل کاربری</h2>
    <form>
      <div class="mb-4">
        <label class="block mb-1" for="email">ایمیل</label>
      ...
      <div class="mb-4">
        <label class="block mb-1" for="password">پسورد</label>
      ...
      <div class="mt-6 flex items-center justify-between">
        <div class="flex items-center">
          ...
          <label for="remember_me" class="ml-2 block text-sm leading-5 text-gray-900">به خاطر بسپار </label>
        </div>
        <a href="#" class="text-sm">رمز عبور را فراموش کرده ام</a>
      </div>
      <div class="mt-6">
        <button class="w-full inline-flex items-center justify-center px-4 py-2 bg-blue-400 border border-transparent rounded-md font-semibold capitalize text-white hover:bg-blue-700 active:bg-red-700 focus:outline-none focus:border-red-700 focus:ring focus:ring-red-200 disabled:opacity-25 transition">ورود</button>
      </div>
